...
imds = imageDatastore('C:\Users\zarat\OneDrive\Msc Data Science\Computer Vision\Face Detection\GroupClassifier','IncludeSubfolders',true,'LabelSource',...
    'foldernames');
...
KNNclassifier = fitcecoc(trainingFeatures, trainingLabels,'Learners',t, 'Options',options);
...
%% Produces accuracies of KNN Model against Test set 
